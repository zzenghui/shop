     ...
     <div class="order-right">
          <div class="order-content">
                  ...
                  <tr v-for="(orderList,index) in order.orderDetailList" :key="orderList.id">
                    <td width="60%">
                      <div class="typographic">
                        <img :src="orderList.imgUrl" width="80px" height="80px">
                        <a href="#" class="block-text">{{orderList.skuName}}</a>
                        <span>{{orderList.skuNum}}</span>
            ...
            <div class="choose-order">
              <PaginationApp :pageNo='page' :pageSide='limit' :total='myOrder.total' :continues='5' @getPageNo="getPageNo"/>
            </div>

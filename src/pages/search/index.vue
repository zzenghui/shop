    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="details clearfix">
              ...
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changOrder('1')">
                  <a>综合 <span v-show="isOne">
                    <i :class="{'el-icon-top':isAsc,'el-icon-bottom':isDesc}" ></i> 
                     </span> 
                  </a>
                </li>
            ...
            <ul class="yui3-g">
              ...
              >
                <div class="list-wrap">
                  ...
                  <div class="commit">
                    <i class="command"
                      >已有<span>{{ getRandomIntInclusive(1,9999) }}</span
                      >人评价</i
                    >
                  </div>
                  <div class="operate">
          ...
          <!-- 分页器 -->
         <PaginationApp :pageNo='searchparams.pageNo' :pageSide='searchparams.pageSize' :total='total' :continues='5' @getPageNo="getPageNo"/>
        </div>
      </div>
    </div>
  </div>
